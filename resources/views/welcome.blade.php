...
<body data-bs-spy="scroll" data-bs-target="#header" tabindex="0">
    ...
    <div class="right-element">
        ...
        @else
		<span class="user-name" style="margin-right: 10px; color: black;">
    <i class="icon icon-user"></i> {{ Auth::user()->name }}
            ...
            <form method="POST" action="{{ route('logout') }}" style="display: inline;">
                @csrf
				<button type="submit" class="cart for-buy" style="border:none; background:none; color: black;">
		...
		<header id="header">
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-md-2">
						<div class="main-logo">
							<a href="index.html"><img src="assets/images/logooo.png" alt="logo"></a>
						</div>
					...
					<div class="main-slider pattern-overlay">
						<div class="slider-item">
							<div class="banner-content">
								<h2 class="banner-title">Kids Trending Glasses</h2>
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eu feugiat amet, libero
									ipsum enim pharetra hac. Urna commodo, lacus ut magna velit eleifend. Amet, quis
									urna, a eu.</p>
								<div class="btn-wrap">
									<a href="#" class="btn btn-outline-accent btn-accent-arrow">Buy Now<i
											class="icon icon-ns-arrow-right"></i></a>
								</div>
							</div><!--banner-content-->
							<img src="assets/images/eyewear2.png" alt="banner" class="banner-image">
						</div><!--slider-item-->

						<div class="slider-item">
							<div class="banner-content">
								<h2 class="banner-title">Summer Vibes Glasses</h2>
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eu feugiat amet, libero
									ipsum enim pharetra hac. Urna commodo, lacus ut magna velit eleifend. Amet, quis
									urna, a eu.</p>
								<div class="btn-wrap">
    ...
    <div class="container">
        <div class="row">
            <div class="inner-content">
                <div class="logo-bar">
                    <div class="logo-row">
                        <a href="#"><img src="assets/images/log1.png" alt="client"></a>
                        <a href="#"><img src="assets/images/log2.png" alt="client"></a>
                        <a href="#"><img src="assets/images/log3.png" alt="client"></a>
                        <a href="#"><img src="assets/images/log4.png" alt="client"></a>
                        <a href="#"><img src="assets/images/log5.png" alt="client"></a>
                    </div>
                </div>
            </div>
        </div>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="section-header align-center">
					...
					<h2 class="section-title">Featured Glasses</h2>
				</div>
						...
						<div class="col-md-3 mb-4">
							<div class="product-item">
								<figure class="product-style">
									<img src="{{ asset('storage/' . $book->image) }}" alt="{{ $book->title }}" class="product-item img-fluid">
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-8">
				<div class="row">
					<div class="col-md-6">
							<img src="assets/images/eight.jpg" alt="book" class="single-image">
						</figure>
					</div>
					<div class="col-md-6">
						<div class="product-entry">
							<h2 class="section-title divider">Best Selling Sunglasses of the Week</h2>
							<div class="products-content">
								<div class="author-name">By Rayban</div>
								<h3 class="item-title">Rayban Model:Aspire Sea</h3>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="section-header align-center mb-4">
                    ...
                    <h2 class="section-title">Popular Glasses</h2>
                </div>

                {{-- Tabs --}}
                <ul class="tabs">
                    @foreach($genres as $genreKey => $genreLabel)
                        <li data-tab-target="#{{ strtolower(str_replace(' ', '-', $genreKey)) }}"
                ...
                <div class="tab-content mt-4">
                    @foreach($genres as $genreKey => $genreLabel)
                        @php
                            $filteredBooks = $genreKey === 'All Genre' ? $books : $books->where('genre', $genreKey);
                            $tabId = strtolower(str_replace(' ', '-', $genreKey));
                        @endphp

                        <div id="{{ $tabId }}" data-tab-content class="{{ $loop->first ? 'active' : '' }}">
                            <div class="row">
                                ...
                                @empty
                                    <p class="px-3">No Items in this category.</p>
                                @endforelse
                            </div>
                        </div>
                    @endforeach
				...
				<div class="col-md-4">
					...
					<div class="footer-item">
						<div class="company-brand">
							<img src="assets/images/logooo.png" alt="logo" class="footer-logo">
